# 0128-confronto-ingressi.req

_eseguito: 2026-09-21 07:02 UTC_

**richiesta:** `confronto`
**eseguito:** `.venv/bin/python -m scripts.confronto_gate_paper`
**esito:** codice 0 in 378.4s
...
==========================================================================
PAPER: 21 trade chiusi · persi 16 · serie di perdite piu' lunga finora: 8
...
[backtest] dati da cache: 60915 candele (DEXEUSDT 15m)
  ...
  INGRESSI: 2/4 trade del paper hanno un ingresso del gate entro 2 barre · scarto mediano 16 min
...
[backtest] dati da cache: 62629 candele (ORCAUSDT 15m)
  ...
  INGRESSI: 1/2 trade del paper hanno un ingresso del gate entro 2 barre · scarto mediano 16 min
...
[backtest] dati da cache: 165409 candele (VETUSDT 15m)
  ...
  INGRESSI: 2/2 trade del paper hanno un ingresso del gate entro 2 barre · scarto mediano 16 min
...
[backtest] dati da cache: 58799 candele (PROMUSDT 15m)
  ...
  INGRESSI: 1/1 trade del paper hanno un ingresso del gate entro 2 barre · scarto mediano 16 min
...
==========================================================================
  ...
  GATE: finestre di 8 trade consecutivi TUTTI persi: 59 su 2299 (2.6%)
  PAPER: 21 trade · persi 16 · serie di perdite piu' lunga: 8
