# 0177-check-24set-ai-stato.req

_eseguito: 2026-09-24 06:13 UTC_

**richiesta:** `ai-stato`
**eseguito:** `.venv/bin/python -m scripts.ai_status`
**esito:** codice 1 in 3.7s

```
==============================================================
STATO DEL LIVELLO AI
==============================================================
❌ chiave: NotFoundError: Error code: 404 - {'type': 'error', 'error': {'type': 'not_found_error', 'message': 'model: claude-opus-4.8 was not found. Did you mean claude-opus-4-8?'}, 'request_id': 'req_011CfMmgPPJiko1Y2PiDvAoo'}
...
✅ prove passate all'AI:
   ...
   - GATE: su 1320 valutazioni ne passano 0; muoiono soprattutto su total_return 1207 · consistency 17 · recovery 64 · regime 22.
...
==============================================================
La chiave non risponde: tutto il resto qui sotto e' fermo di conseguenza.
```
