...
_eseguito: 2026-09-24 19:20 UTC_
...
[mfe] trade chiusi: 53 · con mfe_r registrato: 53
[mfe] scala globale attuale: (1.5, 3.0, 5.0) quote (0.3, 0.3, 0.4)

[mfe] 14 trade su 53 sono in gruppi sotto --min-trades 3 e NON compaiono nelle righe per gruppo (compaiono solo nel TOTALE).
gruppo                               n  mediana  ≥0.5R    ≥1R  ≥1.5R    ≥2R    ≥3R    ≥4R    ≥5R
------------------------------------------------------------------------------------------------
TOTALE (tutti i trade)              53     0.84    70%    43%    25%    15%     6%     6%     2%
...
STOP LOSS divisi per come sono morti (31 su 53 trade):
  sbagliati dall'inizio (mfe < 0.25R) ..........  11   35%   -> problema di INGRESSO
  andati a favore ma sotto il 1° gradino .......  19   61%   -> problema di USCITA
...
----------------------------------------------------------------------------------------------
TOTALE (tutti i trade)              53      -0.250 *      -0.277        -0.556        -0.691  
...
[backtest] dati da binance: 942 candele
[backtest] dati da binance: 366 candele
[backtest] dati da binance: 366 candele
[backtest] dati da binance: 1038 candele
[backtest] dati da binance: 654 candele
[backtest] dati da binance: 366 candele
[backtest] dati da binance: 462 candele
...
--------------------------------------------------------------------------------
TUTUSDT     gen_4465723e            long    1.50   0.70   0.69   no    no    no 
SYRUPUSDT   gen_af734c68            short   1.50   8.62   0.02   no    no    no 
...
(mostrati i 40 piu' recenti su 45)

  trade misurati: 45 · saltati: 8 (senza stop (o stop = ingresso): 8)
  livello strutturale mediano: 3.96R (primo gradino mediano 1.50R)
  raggiunto il primo gradino (TP1) ........   5   11%
  raggiunto il livello strutturale ........   1    2%
  raggiunto il piu' vicino dei due ........   6   13%
  Lettura: il livello strutturale sta in mediana a 3.96R (primo gradino mediano 1.50R) e viene raggiunto nel 2% dei trade contro il 11% del primo gradino: meno spesso del TP1. Prendendo il piu' vicino dei due si arriverebbe nel 13% dei casi; il livello e' piu' vicino del TP1 in 5 trade su 45.
