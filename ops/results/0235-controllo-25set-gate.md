...
[gate] 2844 coppie nel registro · 1236 ancora valutate · soglia 3 pass · un pass ogni 168h di dati nuovi
  ...
  CONGELATE: 1608 coppie non piu' valutate da oltre 3 giorni (1 avevano gia' un passaggio).
  ...
  COMPOSIZIONE (vive): 0 base · 1236 generate.  Nel registro intero: 1608 base su 2844, tetto 3000.
  ...
  ready dichiarato dal registro: True (via numero coppie)
     ...
     deciso il 25 Sep 06:09 su 160 validate / 52 coin coperte / universo 200 · minimi ok: True · copertura ok: False · conteggio ok: True
  ...
  spazio registro: 384 KiB su 879 (44%)
    138 byte a coppia · ci stanno ancora ~3658 coppie oltre le 2844 di adesso
  spazio spec scoperte: 117 KiB su 879 (13%)

  TEMPO DELL'ULTIMO GIRO (discovery): 1h 09m · iniziato 25 Sep 03:30 UTC · finito 04:40 UTC
  IL CERVELLO NELL'ULTIMO GIRO: non registrato: giro precedente al 25 set (le chiavi `intorno`/`varianti` arrivano col primo giro finito)
...
--- QUANDO RIPARTE IL BOT ---
  Al piu' presto il — (fra -20721.3 giorni), quando la 10a coppia
