# 0093-chiave-log-bot.req

_eseguito: 2026-09-19 14:41 UTC_
...
```
Sep 19 00:33:43 Trading-Agent python[1190071]: [main] pesi ricalcolati: 7 coppie strat×regime da 9 trade (30g)
Sep 19 00:44:53 Trading-Agent python[1190071]: [main] market scan...
Sep 19 00:45:41 Trading-Agent python[1190071]: /root/agentic_trading_system/.venv/lib/python3.12/site-packages/google/cloud/firestore_v1/base_collection.py:317: UserWarning: Detected filter using positional arguments. Prefer using the 'filter' keyword argument instead.
Sep 19 00:45:41 Trading-Agent python[1190071]:   return query.where(field_path, op_string, value)
Sep 19 00:45:41 Trading-Agent python[1190071]: [main] valutate 23 coin validate (23 nel registro): ['TUTUSDT', 'PROMUSDT', 'SPXUSDT', 'SYRUPUSDT', 'HEMIUSDT', 'ZKUSDT', 'HEIUSDT', 'JTOUSDT', 'STXUSDT', 'USELESSUSDT', 'VETUSDT', 'JASMYUSDT', 'BICOUSDT', 'DOTUSDT', 'SEIUSDT', 'DEXEUSDT', 'MUBARAKUSDT', 'EGLDUSDT', 'SAHARAUSDT', 'NEIROUSDT', 'ORCAUSDT', 'GPSUSDT', 'SKYAIUSDT']
Sep 19 00:46:57 Trading-Agent python[1190071]: [DRY_RUN] OPEN long STXUSDT qty=698.8818 @ 0.2843 lev=2.0x SL=0.2795 TP=0.2986
Sep 19 00:46:57 Trading-Agent python[1190071]: [ai-shadow] non disponibile (AuthenticationError: Error code: 401 - {'type': 'error', 'error': {'type': 'authentication_error', 'message': 'invalid x-api-key'}, 'request_id': 'req_011CfBskqRFRHticpcycXpWZ'}) -> proseguo senza AI
Sep 19 00:47:03 Trading-Agent python[1190071]: [price_stream] connesso · 2 simboli · wss://fstream.binance.com/stream?streams=dexeusdt@bookTicker/stxusdt@bookTicker
Sep 19 01:33:55 Trading-Agent python[1190071]: /root/agentic_trading_system/.venv/lib/python3.12/site-packages/google/cloud/firestore_v1/base_collection.py:317: UserWarning: Detected filter using positional arguments. Prefer using the 'filter' keyword argument instead.
Sep 19 01:33:55 Trading-Agent python[1190071]:   return query.where(field_path, op_string, value)
Sep 19 01:33:55 Trading-Agent python[1190071]: [learning] solo 9 trade validi (servono 50): pesi INVARIATI
Sep 19 01:33:55 Trading-Agent python[1190071]: [main] pesi ricalcolati: 7 coppie strat×regime da 9 trade (30g)
Sep 19 02:34:21 Trading-Agent python[1190071]: /root/agentic_trading_system/.venv/lib/python3.12/site-packages/google/cloud/firestore_v1/base_collection.py:317: UserWarning: Detected filter using positional arguments. Prefer using the 'filter' keyword argument instead.
Sep 19 02:34:21 Trading-Agent python[1190071]:   return query.where(field_path, op_string, value)
Sep 19 02:34:21 Trading-Agent python[1190071]: [learning] solo 9 trade validi (servono 50): pesi INVARIATI
Sep 19 02:34:21 Trading-Agent python[1190071]: [main] pesi ricalcolati: 7 coppie strat×regime da 9 trade (30g)
Sep 19 03:34:22 Trading-Agent python[1190071]: /root/agentic_trading_system/.venv/lib/python3.12/site-packages/google/cloud/firestore_v1/base_collection.py:317: UserWarning: Detected filter using positional arguments. Prefer using the 'filter' keyword argument instead.
Sep 19 03:34:22 Trading-Agent python[1190071]:   return query.where(field_path, op_string, value)
Sep 19 03:34:22 Trading-Agent python[1190071]: [learning] solo 9 trade validi (servono 50): pesi INVARIATI
