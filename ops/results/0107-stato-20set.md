...
_Generato: 2026-09-20 04:31 UTC_
...
- DRY_RUN: True
- equity: **$983.46**
- ultimo heartbeat: 2026-09-20 04:31 UTC
- stream prezzi: 🟢 attivo

## Ultima decisione
- esito: **⚪ FLAT** (2026-09-20 04:31 UTC)
- motivo: nessun segnale valido sopra soglia
- asset valutati: 25 · segnali: 0

## Posizioni aperte
- PROMUSDT: short qty=26.019551162917683 @ 5.286 uPnL=2.5650798862915107 · rischio 0.26% · leva 2.0x
- SPXUSDT: long qty=424.64303550478166 @ 0.4626 uPnL=0.3010978034967823 · rischio 0.46% · leva 2.0x
- **rischio aperto totale: 0.72%** dell'equity su 2 posizioni

## GATE 1 — Validazione strategie
- stato: **✅ SUPERATO — pronti per il paper trading**
- copertura universo: **25/164 crypto (15%)** · obiettivo ≥ 35%
- coppie validate (>= 3 pass OOS): **52**
- universo scansionato: 0GUSDT, 1000BONKUSDT, 1000FLOKIUSDT, 1000PEPEUSDT, 1000SHIBUSDT, AAVEUSDT, ACEUSDT, ACHUSDT, ADAUSDT, AEROUSDT, AGLDUSDT, AINUSDT, ALGOUSDT, APTUSDT, ARBUSDT, ARKUSDT, ARUSDT, ASTERUSDT, ATOMUSDT, AVAUSDT, AVAXUSDT, AXSUSDT, B2USDT, BANKUSDT, BCHUSDT, BERAUSDT, BIOUSDT, BNBUSDT, BOMEUSDT, BRUSDT, BTCUSDT, BULLAUSDT, BUSDT, CAKEUSDT, CELRUSDT, CHILLGUYUSDT, CHZUSDT, COMPUSDT, COTIUSDT, CROSSUSDT, CRVUSDT, CTSIUSDT, CUSDT, CVCUSDT, DASHUSDT, DEXEUSDT, DOGEUSDT, DOTUSDT, DRIFTUSDT, DYDXUSDT, EGLDUSDT, EIGENUSDT, ENAUSDT, ENSUSDT, EPICUSDT, ETCUSDT, ETHFIUSDT, ETHUSDT, FARTCOINUSDT, FETUSDT, FILUSDT, FLOCKUSDT, FUSDT, GALAUSDT, GUSDT, HBARUSDT, HEIUSDT, HEMIUSDT, HOMEUSDT, HYPEUSDT, ICPUSDT, IMXUSDT, INJUSDT, IOSTUSDT, IOTAUSDT, JSTUSDT, JTOUSDT, JUPUSDT, KAITOUSDT, KASUSDT, KAVAUSDT, LAUSDT, LDOUSDT, LINKUSDT, LPTUSDT, LSKUSDT, LTCUSDT, MANAUSDT, MINAUSDT, MITOUSDT, MOODENGUSDT, MORPHOUSDT, MTLUSDT, MUSDT, MYXUSDT, NEARUSDT, NEIROUSDT, NEOUSDT, NILUSDT, ONDOUSDT, ONEUSDT, ONGUSDT, OPUSDT, ORDIUSDT, PAXGUSDT, PENDLEUSDT, PENGUUSDT, PEOPLEUSDT, PNUTUSDT, POLUSDT, PROMUSDT, PUMPUSDT, PYTHUSDT, RAYSOLUSDT, REDUSDT, RENDERUSDT, REZUSDT, SAGAUSDT, SANDUSDT, SEIUSDT, SKLUSDT, SKYUSDT, SOLUSDT, SOLVUSDT, SOPHUSDT, SPXUSDT, STGUSDT, STRKUSDT, STXUSDT, SUIUSDT, SUSDT, SUSHIUSDT, SYNUSDT, TAOUSDT, THETAUSDT, TIAUSDT, TRBUSDT, TREEUSDT, TRUMPUSDT, TRXUSDT, TUSDT, TUTUSDT, UBUSDT, UNIUSDT, USELESSUSDT, USUALUSDT, VELVETUSDT, VETUSDT, VIRTUALUSDT, VTHOUSDT, VVVUSDT, WIFUSDT, WLDUSDT, WLFIUSDT, XLMUSDT, XMRUSDT, XPLUSDT, XRPUSDT, XTZUSDT, ZECUSDT, ZENUSDT, ZILUSDT, ZKUSDT, ZROUSDT
- aggiornato: 2026-09-20 03:42 UTC

### Salute del registro

- composizione: **2024 base** · **616 generate** (di cui 616 con almeno una conferma)
- occupazione: 2640/3000 — ok
...
_aggiornato: 2026-09-20 03:42 UTC · 1312 coppie valutate, 0 passate in questo run_

_Nessuna coppia ha passato in questo run._

## Dove muoiono le candidate (autopsia del GATE 1)

**strategie base** — 1312 valutazioni, 0 passate (0.00%) · 2026-09-20 03:42 UTC
...
**strategie generate** — 105570 valutazioni, 312 passate (0.30%) · 2026-09-20 02:50 UTC

| Criterio che ferma | Casi | Quota |
|---|---|---|
| total_return | 70909 | 67.4% |
| holdout | 954 | 0.9% |
| recovery | 9168 | 8.7% |
| consistency | 3169 | 3.0% |
| pf_ex_top | 1439 | 1.4% |
| win_rate | 19 | 0.0% |
| trades | 2784 | 2.6% |
| regime | 16816 | 16.0% |
...
- ultimo giro: 2026-09-20 04:03 UTC · coppie validate: **52** · GATE 1 pronto: True
- tasso di passaggio misurato: **0.292%**
...
- totale: **15** · vinti: 4 (27%) · PnL realizzato: **-17.99**
- confronto col mercato: noi -1.80% vs BTC buy&hold +6.21% nello stesso periodo → **sotto** il mercato

- costi: **4.61 USDT** su 15 trade (0.31/trade) _(stimati dal modello del gate, non misurati dai fill)_
  - commissioni 2.38 · spread 2.24 · funding -0.02
  - lordo -13.39 → netto -17.99 · **break-even 0.47%** dell'equity
  - piu' costose: DEXEUSDT 1.28 · SYRUPUSDT 0.63 · VETUSDT 0.54 · GPSUSDT 0.34 · NEIROUSDT 0.32

| Uscita | Trade | % | PnL |
|---|---|---|---|
| Stop loss (prima di qualsiasi TP) | 11 | 73% | -34.23 |
| Scale-out (>=1 TP incassato, residuo a BE) | 3 | 20% | +5.93 |
| Take profit (fino all'ultimo gradino) | 1 | 7% | +10.30 |

- gradini raggiunti (su 15 trade): 0 TP: 11 (73%) · 1 TP: 3 (20%) · 3 TP: 1 (7%)

- **drawdown di portafoglio: 20.05 USDT** (ritorno -17.99 · recovery -0.90) · max 4 posizioni aperte insieme
  _uscite in ordine di TEMPO: e' la buca vera, quella che il gate non vede perche' valida una coppia alla volta._

- escursione favorevole (mfe_r, 15 trade): mediana **0.85R** · ≥1R: 40% · ≥1.5R: 33% · ≥3R: 7% · ≥5R: 0%
...
- **globale**: watch · 15 trade · PF vissuto 0.474 vs 1.859 atteso · mfe mediana 0.85R
