# 0068-numeri-decisione.req

_eseguito: 2026-09-16 09:45 UTC_
...
[gate] 2410 coppie nel registro · 2104 ancora valutate · soglia 3 pass · un pass ogni 168h di dati nuovi
  distribuzione pass (solo coppie vive): 0 pass: 1680 su 210 coin · 1 pass: 299 su 94 coin · 2 pass: 94 su 42 coin · 3 pass: 31 su 16 coin
  CONGELATE: 306 coppie non piu' valutate da oltre 3 giorni (34 avevano gia' un passaggio).
  ...
  COMPOSIZIONE (vive): 1680 base · 424 generate.  Nel registro intero: 1952 base su 2410, tetto 3000.
  fallimenti accumulati: 1 fallimenti: 1000
  VALIDATE ora: 31 su 16 coin distinte
  ready dichiarato dal registro: False (via —)
     copertura 10.3% su obiettivo 35% · via a conteggio: 10 coppie (0 = spenta) · minimi 10 coin nell'universo, 5 coperte
  FINESTRE APERTE: 424/424 coppie con almeno un passaggio.
...
--- QUANDO RIPARTE IL BOT ---
  Al piu' presto il — (fra -20712.4 giorni), quando la 10a coppia
