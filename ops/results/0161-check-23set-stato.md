...
_Generato: 2026-09-23 06:02 UTC_
...
- DRY_RUN: True
- equity: **$968.91**
- ultimo heartbeat: 2026-09-23 06:02 UTC
- stream prezzi: 🟢 attivo

## Ultima decisione
- esito: **⚪ FLAT** (2026-09-23 06:01 UTC)
- motivo: nessun segnale valido sopra soglia
- asset valutati: 27 · segnali: 0

## Posizioni aperte
- MUBARAKUSDT: long qty=915.3240188177886 @ 0.07022 uPnL=-2.818493569941042 · rischio 1.01% · leva 2.0x
- VETUSDT: short qty=19950.842419800843 @ 0.009713 uPnL=0.2962403171748106 · rischio 0.47% · leva 2.0x
- **rischio aperto totale: 1.48%** dell'equity su 2 posizioni

## GATE 1 — Validazione strategie
- stato: **✅ SUPERATO — pronti per il paper trading**
- copertura universo: **27/200 crypto (14%)** · obiettivo ≥ 35%
- coppie validate (>= 3 pass OOS): **59**
- universo scansionato: 0GUSDT, 1000BONKUSDT, 1000FLOKIUSDT, 1000PEPEUSDT, 1000SHIBUSDT, 1000XECUSDT, 4USDT, AAVEUSDT, ACEUSDT, ADAUSDT, AEROUSDT, AGTUSDT, AINUSDT, AKEUSDT, ALGOUSDT, ALICEUSDT, ALLOUSDT, APEUSDT, API3USDT, APTUSDT, ARBUSDT, ARUSDT, ARXUSDT, ASTERUSDT, ATOMUSDT, AVAUSDT, AVAXUSDT, AXSUSDT, BABYUSDT, BANKUSDT, BCHUSDT, BEATUSDT, BERAUSDT, BIOUSDT, BNBUSDT, BOMEUSDT, BROCCOLI714USDT, BRUSDT, BSVUSDT, BTCUSDT, BTWUSDT, CAKEUSDT, CARVUSDT, CCUSDT, CELRUSDT, CFXUSDT, CHIPUSDT, CHRUSDT, CHZUSDT, CLOUSDT, COOKIEUSDT, COTIUSDT, CRVUSDT, CVCUSDT, CYSUSDT, DASHUSDT, DATAIPUSDT, DOGEUSDT, DOLOUSDT, DOTUSDT, DRIFTUSDT, EDGEUSDT, EGLDUSDT, EIGENUSDT, ENAUSDT, ENSUSDT, EPICUSDT, ETCUSDT, ETHFIUSDT, ETHUSDT, EULUSDT, EVAAUSDT, FARTCOINUSDT, FETUSDT, FFUSDT, FILUSDT, FLOCKUSDT, FOLKSUSDT, FORMUSDT, GALAUSDT, GENIUSUSDT, GIGGLEUSDT, GPSUSDT, GRAMUSDT, GRASSUSDT, GRTUSDT, GUSDT, HBARUSDT, HEMIUSDT, HOMEUSDT, HOTUSDT, HUSDT, HYPEUSDT, ICPUSDT, INJUSDT, INUSDT, IOSTUSDT, JTOUSDT, JUPUSDT, KAITOUSDT, KASUSDT, KERNELUSDT, KITEUSDT, LABUSDT, LAUSDT, LDOUSDT, LINKUSDT, LITUSDT, LSKUSDT, LTCUSDT, LUNA2USDT, MAGMAUSDT, MARSCOINUSDT, METUSDT, MINAUSDT, MONUSDT, MOODENGUSDT, MORPHOUSDT, MOVRUSDT, MUBARAKUSDT, NEARUSDT, NEIROUSDT, NILUSDT, ONDOUSDT, ONEUSDT, ONGUSDT, ONUSDT, OPGUSDT, OPUSDT, ORDIUSDT, PAXGUSDT, PENDLEUSDT, PENGUUSDT, PEOPLEUSDT, PHAUSDT, PIEVERSEUSDT, PLUMEUSDT, PNUTUSDT, POLUSDT, PONSUSDT, PROMUSDT, PROVEUSDT, PTBUSDT, PUMPUSDT, PYTHUSDT, QNTUSDT, RAYSOLUSDT, RENDERUSDT, REUSDT, RIVERUSDT, RUNEUSDT, SAGAUSDT, SANDUSDT, SEIUSDT, SKRUSDT, SKYUSDT, SOLUSDT, SOPHUSDT, SPXUSDT, STRKUSDT, STXUSDT, SUIUSDT, SUSDT, SUSHIUSDT, SXTUSDT, SYNUSDT, TAOUSDT, TIAUSDT, TRBUSDT, TRUMPUSDT, TRXUSDT, TSTUSDT, TUSDT, TUTUSDT, UAIUSDT, UNIUSDT, USELESSUSDT, VETUSDT, VIRTUALUSDT, VTHOUSDT, VVVUSDT, WIFUSDT, WLDUSDT, WLFIUSDT, XAUTUSDT, XLMUSDT, XMRUSDT, XPLUSDT, XRPUSDT, ZAMAUSDT, ZBTUSDT, ZECUSDT, ZENUSDT, ZESTUSDT, ZETAUSDT, ZKUSDT, ZROUSDT, 哈基米USDT, 牛来USDT, 龙虾USDT
- aggiornato: 2026-09-23 05:50 UTC

### Salute del registro

- composizione: **1864 base** · **1025 generate** (di cui 1025 con almeno una conferma)
- occupazione: 2889/3000 — ok
...
| SKYAIUSDT | gen_c61d9322 | 3 | 3.336 | 92% | scale_r_mults=[2.0, 4.0, 6.0], sl_to_breakeven=True |
...
| JTOUSDT | gen_f238d283 | 3 | 1.727 | 66% | scale_r_mults=[1.5, 3.0, 5.0], sl_to_breakeven=True |
...
| BULLAUSDT | gen_7ac562e3 | 3 | 3.54 | 52% | scale_r_mults=[1.5, 3.0, 5.0], sl_to_breakeven=True |
| NEIROUSDT | gen_d53c153b | 3 | 1.808 | 49% | scale_r_mults=[1.0, 2.0, 3.0] |
| JTOUSDT | gen_35632db9 | 3 | 1.658 | 48% | scale_r_mults=[1.5, 3.0, 5.0], sl_to_breakeven=True |
| QUSDT | gen_bf2be656 | 3 | 3.119 | 48% | scale_r_mults=[1.5, 3.0, 5.0], sl_to_breakeven=True |
...
**strategie generate** — 133484 valutazioni, 310 passate (0.23%) · 2026-09-23 05:50 UTC
...
| holdout | 776 | 0.6% |
| pf_ex_top | 1140 | 0.9% |
| total_return | 99069 | 74.4% |
| consistency | 3434 | 2.6% |
| recovery | 11462 | 8.6% |
...
- ultimo giro: 2026-09-23 06:01 UTC · coppie validate: **59** · GATE 1 pronto: True
- tasso di passaggio misurato: **0.230%**
...
- totale: **37** · vinti: 14 (38%) · PnL realizzato: **-31.09**
- confronto col mercato: noi -3.11% vs BTC buy&hold +14.12% nello stesso periodo → **sotto** il mercato

- costi: **10.13 USDT** su 37 trade (0.27/trade) _(stimati dal modello del gate, non misurati dai fill)_
  - commissioni 5.65 · spread 4.55 · funding -0.07
  - lordo -20.96 → netto -31.09 · **break-even 1.05%** dell'equity
  - piu' costose: DEXEUSDT 1.91 · SPXUSDT 0.96 · USELESSUSDT 0.94 · SYRUPUSDT 0.93 · STXUSDT 0.77

| Uscita | Trade | % | PnL |
|---|---|---|---|
| Stop loss (prima di qualsiasi TP) | 23 | 62% | -100.76 |
| Trailing stop | 6 | 16% | +18.79 |
...
- gradini raggiunti (su 37 trade): 0 TP: 29 (78%) · 1 TP: 5 (14%) · 2 TP: 1 (3%) · 3 TP: 2 (5%)

- **drawdown di portafoglio: 61.78 USDT** (ritorno -31.09 · recovery -0.50) · max 7 posizioni aperte insieme
  _uscite in ordine di TEMPO: e' la buca vera, quella che il gate non vede perche' valida una coppia alla volta._

- escursione favorevole (mfe_r, 37 trade): mediana **0.85R** · ≥1R: 43% · ≥1.5R: 27% · ≥3R: 8% · ≥5R: 3%
...
- **globale**: watch · 37 trade · PF vissuto 0.691 vs 1.942 atteso · mfe mediana 0.85R
...
|---|---|---|---|
| 60.0–60.0 | 12 | 75% | +2.67% |
| 60.0–60.0 | 12 | 25% | -2.96% |
