# 0259-controllo-26set-stato.req
...
_Generato: 2026-09-26 06:05 UTC_
...
- DRY_RUN: True
- equity: **$936.27**
- ultimo heartbeat: 2026-09-26 06:05 UTC
- stream prezzi: 🟢 attivo

## Ultima decisione
- esito: **⚪ FLAT** (2026-09-26 06:02 UTC)
- motivo: parita' backtest: 1 segnali validi aperti
- asset valutati: 62 · segnali: 3 · miglior segnale MUBARAKUSDT gen_ff3e4154 (conf. 60.0/soglia 30)

## Posizioni aperte
- NEIROUSDT: long qty=998691.301337025 @ 9.375e-05 uPnL=-0.8102868812740975 · rischio 0.15% · leva 1.0x
- SYRUPUSDT: short qty=426.48620774294113 @ 0.22006 uPnL=-0.3754274612538234 · rischio 0.15% · leva 1.0x
- **rischio aperto totale: 0.30%** dell'equity su 2 posizioni

## GATE 1 — Validazione strategie
- stato: **✅ SUPERATO — pronti per il paper trading**
- copertura universo: **62/200 crypto (31%)** · obiettivo ≥ 35%
- coppie validate (>= 3 pass OOS): **182**
- universo scansionato: 0GUSDT, 1000BONKUSDT, 1000FLOKIUSDT, 1000PEPEUSDT, 1000SHIBUSDT, 2ZUSDT, 4USDT, AAVEUSDT, ACEUSDT, ADAUSDT, AEROUSDT, AKEUSDT, ALGOUSDT, ALICEUSDT, ALLOUSDT, APEUSDT, APRUSDT, APTUSDT, ARBUSDT, ARKUSDT, ARUSDT, ASTERUSDT, ATOMUSDT, AVAXUSDT, AVNTUSDT, AXSUSDT, BANKUSDT, BBUSDT, BCHUSDT, BEATUSDT, BILLUSDT, BIOUSDT, BNBUSDT, BOMEUSDT, BROCCOLI714USDT, BRUSDT, BTCUSDT, BTRUSDT, BTWUSDT, CAKEUSDT, CAPUSDT, CCUSDT, CETUSUSDT, CFGUSDT, CFXUSDT, CHIPUSDT, CHZUSDT, CLOUSDT, COLLECTUSDT, COTIUSDT, CRVUSDT, CVCUSDT, DASHUSDT, DEEPUSDT, DOGEUSDT, DOTUSDT, DYDXUSDT, EDGEUSDT, EGLDUSDT, EIGENUSDT, ENAUSDT, ENSUSDT, ESPUSDT, ETCUSDT, ETHFIUSDT, ETHUSDT, FARTCOINUSDT, FETUSDT, FFUSDT, FILUSDT, FLOCKUSDT, FORMUSDT, GALAUSDT, GASUSDT, GIGGLEUSDT, GRAMUSDT, GRASSUSDT, GRTUSDT, GUSDT, HBARUSDT, HUMAUSDT, HUSDT, HYPEUSDT, ICPUSDT, INJUSDT, IOSTUSDT, IOTAUSDT, JASMYUSDT, JOEUSDT, JSTUSDT, JTOUSDT, JUPUSDT, KAITOUSDT, KASUSDT, KAVAUSDT, KITEUSDT, KMNOUSDT, LABUSDT, LAUSDT, LDOUSDT, LINKUSDT, LITUSDT, LSKUSDT, LTCUSDT, LYNUSDT, MANAUSDT, MARSCOINUSDT, METUSDT, MINAUSDT, MONUSDT, MOODENGUSDT, MORPHOUSDT, MOVEUSDT, MOVRUSDT, MUBARAKUSDT, MYXUSDT, NEARUSDT, NEIROUSDT, NILUSDT, NOMUSDT, OGNUSDT, ONDOUSDT, ONEUSDT, ONGUSDT, OPUSDT, ORDIUSDT, PAXGUSDT, PENDLEUSDT, PENGUUSDT, PEOPLEUSDT, PHAROSUSDT, PHAUSDT, PIXELUSDT, PLAYUSDT, PLUMEUSDT, POLUSDT, PONSUSDT, PROMUSDT, PUMPUSDT, PYTHUSDT, QNTUSDT, RAREUSDT, RAYSOLUSDT, RENDERUSDT, REUSDT, REZUSDT, RIVERUSDT, RONINUSDT, RUNEUSDT, SAGAUSDT, SANDUSDT, SEIUSDT, SENTUSDT, SKYUSDT, SOLUSDT, SPKUSDT, SPXUSDT, STEEMUSDT, STOUSDT, STRKUSDT, STXUSDT, SUIUSDT, SUSHIUSDT, SYNUSDT, SYRUPUSDT, TAKEUSDT, TAOUSDT, TIAUSDT, TRBUSDT, TRUMPUSDT, TRXUSDT, TSTUSDT, TUTUSDT, UAIUSDT, UNIUSDT, USELESSUSDT, USUSDT, VELODROMEUSDT, VETUSDT, VIRTUALUSDT, VTHOUSDT, VVVUSDT, WAXPUSDT, WIFUSDT, WLDUSDT, WLFIUSDT, XAIUSDT, XAUTUSDT, XLMUSDT, XMRUSDT, XPLUSDT, XRPUSDT, ZAMAUSDT, ZECUSDT, ZENUSDT, ZETAUSDT, ZKUSDT, ZROUSDT, 牛来USDT, 龙虾USDT
- aggiornato: 2026-09-26 06:03 UTC

### Salute del registro

- composizione: **1536 base** · **1323 generate** (di cui 1323 con almeno una conferma)
- occupazione: 2859/3000 — ok
...
| SKYAIUSDT | gen_f68b811d | 3 | 2.289 | 46% | scale_r_mults=[2.0, 4.0, 6.0], sl_to_breakeven=True, profit_lock_keep=0.35 |
...
| BTRUSDT | gen_8981d5f2 | 3 | None | 0% | scale_r_mults=[1.

[... 5283 caratteri omessi (testa e coda conservate) ...]
...
**strategie generate** — 345 valutazioni, 1 passate (0.29%) · 2026-09-26 06:03 UTC

| Criterio che ferma | Casi | Quota |
|---|---|---|
| pf_ex_top | 4 | 1.2% |
| regime | 24 | 7.0% |
| total_return | 215 | 62.5% |
| consistency | 10 | 2.9% |
| recovery | 71 | 20.6% |
| holdout | 2 | 0.6% |
| trades | 18 | 5.2% |
...
- ultimo giro: 2026-09-26 06:02 UTC · coppie validate: **183** · GATE 1 pronto: True
- tasso di passaggio misurato: **0.061%**
...
- totale: **84** · vinti: 39 (46%) · PnL realizzato: **-63.73**
- confronto col mercato: noi -6.37% vs BTC buy&hold +10.77% nello stesso periodo → **sotto** il mercato

- costi: **16.49 USDT** su 84 trade (0.20/trade) _(stimati dal modello del gate, non misurati dai fill)_
  - commissioni 9.49 · spread 7.01 · funding -0.01
  - lordo -47.23 → netto -63.73 · **break-even 1.76%** dell'equity
  - piu' costose: DEXEUSDT 2.14 · SPXUSDT 1.24 · QUSDT 1.10 · ORCAUSDT 1.06 · USELESSUSDT 1.03
  - ⚠️ Costi operativi elevati: servono 1.76% solo per pareggiare (soglia 1.5%)

| Uscita | Trade | % | PnL |
|---|---|---|---|
| Stop loss (prima di qualsiasi TP) | 45 | 54% | -165.54 |
...
- gradini raggiunti (su 84 trade): 0 TP: 74 (88%) · 1 TP: 7 (8%) · 2 TP: 1 (1%) · 3 TP: 2 (2%)

- **drawdown di portafoglio: 71.40 USDT** (ritorno -63.73 · recovery -0.89) · max 8 posizioni aperte insieme
...
- escursione favorevole (mfe_r, 84 trade): mediana **0.84R** · ≥1R: 37% · ≥1.5R: 19% · ≥3R: 5% · ≥5R: 1%
...
- **globale**: drift · 84 trade · PF vissuto 0.615 vs 2.091 atteso · mfe mediana 0.84R

- **freno globale attivo**: size x0.5 e leva x0.71 (radice) su OGNI trade finche' il PF a 30 giorni resta sotto 0.6 x atteso (motivo: PF 0.62 vs 2.09 atteso · mfe mediana 0.84R < primo TP 1.50R)
...
- verdetto: **costante** · 84 trade · correlazione None · influenza applicata **x1.0**
- tutte le strategie generate escono a confidenza 60: la calibrazione non puo' misurare nulla finche' la confidenza non varia (84 trade, confidenza 60-60)

| Fascia di confidenza | Trade | Win rate | Esito medio |
|---|---|---|---|
| 60.0–60.0 | 28 | 57% | -0.31% |
| 60.0–60.0 | 28 | 57% | -0.82% |
