...
_Generato: 2026-09-20 13:00 UTC_
...
- DRY_RUN: True
- equity: **$984.13**
- ultimo heartbeat: 2026-09-20 12:59 UTC
- stream prezzi: 🟢 attivo

## Ultima decisione
- esito: **⚪ FLAT** (2026-09-20 12:46 UTC)
- motivo: nessun segnale valido sopra soglia
- asset valutati: 25 · segnali: 0

## Posizioni aperte
- GPSUSDT: long qty=19205.78570954366 @ 0.010285 uPnL=0.3638141539005122 · rischio 0.41% · leva 2.0x
- **rischio aperto totale: 0.41%** dell'equity su 1 posizioni

## GATE 1 — Validazione strategie
- stato: **✅ SUPERATO — pronti per il paper trading**
- copertura universo: **25/164 crypto (15%)** · obiettivo ≥ 35%
- coppie validate (>= 3 pass OOS): **54**
- universo scansionato: 0GUSDT, 1000BONKUSDT, 1000FLOKIUSDT, 1000PEPEUSDT, 1000SHIBUSDT, AAVEUSDT, ACEUSDT, ADAUSDT, AEROUSDT, AGLDUSDT, AINUSDT, ALGOUSDT, APTUSDT, ARBUSDT, ARKUSDT, ARUSDT, ASTERUSDT, ATOMUSDT, AVAUSDT, AVAXUSDT, AXSUSDT, B2USDT, BANKUSDT, BCHUSDT, BERAUSDT, BIOUSDT, BNBUSDT, BOMEUSDT, BRUSDT, BTCUSDT, BULLAUSDT, CAKEUSDT, CELOUSDT, CELRUSDT, CFXUSDT, CHZUSDT, COTIUSDT, CRVUSDT, CTSIUSDT, CUSDT, CVCUSDT, CYBERUSDT, DASHUSDT, DEXEUSDT, DOGEUSDT, DOTUSDT, DRIFTUSDT, DYDXUSDT, EGLDUSDT, EIGENUSDT, ENAUSDT, ENSUSDT, EPICUSDT, ETCUSDT, ETHFIUSDT, ETHUSDT, FARTCOINUSDT, FETUSDT, FILUSDT, FLOCKUSDT, FUSDT, GALAUSDT, GASUSDT, GUNUSDT, GUSDT, HBARUSDT, HEIUSDT, HEMIUSDT, HOMEUSDT, HYPEUSDT, ICPUSDT, IMXUSDT, INJUSDT, IOSTUSDT, IOTAUSDT, IOTXUSDT, JSTUSDT, JTOUSDT, JUPUSDT, KAITOUSDT, KASUSDT, KAVAUSDT, LAUSDT, LDOUSDT, LINKUSDT, LSKUSDT, LTCUSDT, MANAUSDT, MINAUSDT, MITOUSDT, MOODENGUSDT, MORPHOUSDT, MUSDT, MYXUSDT, NEARUSDT, NEIROUSDT, NEOUSDT, NILUSDT, ONDOUSDT, ONEUSDT, ONGUSDT, OPUSDT, ORDIUSDT, PAXGUSDT, PENDLEUSDT, PENGUUSDT, PEOPLEUSDT, PLUMEUSDT, POLUSDT, PROMUSDT, PROVEUSDT, PTBUSDT, PUMPUSDT, PYTHUSDT, RAYSOLUSDT, RENDERUSDT, REZUSDT, SAGAUSDT, SANDUSDT, SEIUSDT, SKLUSDT, SKYUSDT, SOLUSDT, SOLVUSDT, SOPHUSDT, SPXUSDT, STGUSDT, STRKUSDT, STXUSDT, SUIUSDT, SUSDT, SUSHIUSDT, SYNUSDT, TAGUSDT, TAOUSDT, TIAUSDT, TRBUSDT, TRUMPUSDT, TRXUSDT, TUSDT, TUTUSDT, UBUSDT, UNIUSDT, USELESSUSDT, USUALUSDT, VELVETUSDT, VETUSDT, VIRTUALUSDT, VTHOUSDT, VVVUSDT, WIFUSDT, WLDUSDT, WLFIUSDT, WUSDT, XLMUSDT, XMRUSDT, XPLUSDT, XRPUSDT, XTZUSDT, ZECUSDT, ZENUSDT, ZILUSDT, ZKUSDT, ZROUSDT
- aggiornato: 2026-09-20 12:48 UTC

### Salute del registro

- composizione: **1992 base** · **637 generate** (di cui 637 con almeno una conferma)
- occupazione: 2629/3000 — ok
...
| ORCAUSDT | gen_e6ddc613 | 3 | 1.863 | 113% | scale_r_mults=[1.5, 3.0, 5.0] |
...
| PROMUSDT | gen_452d4511 | 3 | 2.092 | 71% | scale_r_mults=[2.0, 4.0, 6.0] |
| ORCAUSDT | gen_6d06dca0 | 3 | 1.967 | 70% | scale_r_mults=[1.5, 3.0, 5.0] |
| TRUMPUSDT | gen_0e000630 | 3 | 2.222 | 66% | scale_r_mults=[2.0, 4.0, 6.0] |
...
| SAHARAUSDT | gen_6b94025f | 3 | 2.206 | 44% | scale_r_mults=[1.0, 2.0, 3.0] |
| HEMIUSDT | gen_108c996b | 3 | 1.987 | 40% | scale_r_mults=[2.0, 4.0, 6.0] |
| HEMIUSDT | gen_93131ef1 | 3 | 1.987 | 40% | scale_r_mults=[2.0, 4.0, 6.0] |
...
| TRUMPUSDT | gen_108c996b | 3 | 1.733 | 24% | scale_r_mults=[2.0, 4.0, 6.0] |
| TRUMPUSDT | gen_93131ef1 | 3 | 1.733 | 24% | scale_r_mults=[2.0, 4.0, 6.0] |
| ZKUSDT | gen_98837ec2 | 3 | 1.476 | 22% | scale_r_mults=[2.0, 4.0, 6.0] |

## Ultimo run di ottimizzazione
_aggiornato: 2026-09-20 12:48 UTC · 1312 coppie valutate, 0 passate in questo run_

_Nessuna coppia ha passato in questo run._

## Dove muoiono le candidate (autopsia del GATE 1)

**strategie base** — 1312 valutazioni, 0 passate (0.00%) · 2026-09-20 12:48 UTC

| Criterio che ferma | Casi | Quota |
|---|---|---|
| recovery | 75 | 5.7% |
| total_return | 1161 | 88.5% |
| pf_ex_top | 14 | 1.1% |
| trades | 6 | 0.5% |
| consistency | 18 | 1.4% |
| regime | 36 | 2.7% |
...
**strategie generate** — 112230 valutazioni, 325 passate (0.29%) · 2026-09-20 12:07 UTC
...
| win_rate | 21 | 0.0% |
| trades | 2309 | 2.1% |
| consistency | 3389 | 3.0% |
| total_return | 75834 | 67.8% |
| pf_ex_top | 1589 | 1.4% |
| holdout | 983 | 0.9% |
...
- ultimo giro: 2026-09-20 12:01 UTC · coppie validate: **52** · GATE 1 pronto: True
...
- totale: **18** · vinti: 5 (28%) · PnL realizzato: **-15.87**
- confronto col mercato: noi -1.59% vs BTC buy&hold +6.25% nello stesso periodo → **sotto** il mercato

- costi: **5.47 USDT** su 18 trade (0.30/trade) _(stimati dal modello del gate, non misurati dai fill)_
  - commissioni 2.85 · spread 2.65 · funding -0.03
  - lordo -10.40 → netto -15.87 · **break-even 0.56%** dell'equity
  - piu' costose: DEXEUSDT 1.28 · SPXUSDT 0.96 · SYRUPUSDT 0.63 · VETUSDT 0.54 · GPSUSDT 0.34

| Uscita | Trade | % | PnL |
|---|---|---|---|
| Stop loss (prima di qualsiasi TP) | 13 | 72% | -42.59 |
| Scale-out (>=1 TP incassato, residuo a BE) | 3 | 17% | +5.93 |
| Take profit (fino all'ultimo gradino) | 2 | 11% | +20.78 |

- gradini raggiunti (su 18 trade): 0 TP: 13 (72%) · 1 TP: 3 (17%) · 3 TP: 2 (11%)

- **drawdown di portafoglio: 22.82 USDT** (ritorno -15.87 · recovery -0.70) · max 4 posizioni aperte insieme
  _uscite in ordine di TEMPO: e' la buca vera, quella che il gate non vede perche' valida una coppia alla volta._

- escursione favorevole (mfe_r, 18 trade): mediana **0.85R** · ≥1R: 39% · ≥1.5R: 33% · ≥3R: 11% · ≥5R: 6%
...
- **globale**: watch · 18 trade · PF vissuto 0.627 vs 1.866 atteso · mfe mediana 0.85R
...
| DEXEUSDT|gen_fa304106 | watch | 2 | 0.0 / 2.06 | PF 0.00 vs 2.06 atteso · mfe mediana 0.59R < primo TP 1.50R |
...
- verdetto: **insufficient** · 18 trade · correlazione None · influenza applicata **x1.0**
- servono 30 trade, ce ne sono 18
