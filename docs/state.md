...
_Generato: 2026-06-16 13:39 UTC_
...
- DRY_RUN: True
- equity: **$10,054.78**
- ultimo heartbeat: 2026-06-16 13:39 UTC
...
|---|---|---|---|---|---|
| XRPUSDT | trend_following | 6 | 1.343 | 167% | require_volume=False, rr=2.5, atr_mult_stop=2.0, rsi_hi=75.0 |
| WLDUSDT | trend_following | 6 | 1.175 | 156% | require_volume=False, rr=2.5, atr_mult_stop=1.0, rsi_hi=75.0 |
| PEPEUSDT | trend_following | 6 | 1.112 | 95% | require_volume=True, rr=1.5, atr_mult_stop=2.0, rsi_hi=75.0 |
...
| INJUSDT | mean_reversion | 6 | 1.652 | 55% | rsi_oversold=30.0, atr_mult_stop=1.0, rsi_overbought=75.0 |
| XRPUSDT | vwap_reversion | 6 | 1.103 | 54% | deviation_atr=1.5, atr_mult_stop=1.0 |
| PEPEUSDT | mean_reversion | 6 | 1.791 | 52% | rsi_oversold=30.0, atr_mult_stop=1.2, rsi_overbought=70.0 |
| GALAUSDT | mean_reversion | 6 | 1.89 | 47% | rsi_oversold=30.0, atr_mult_stop=1.0, rsi_overbought=80.0 |
| ORDIUSDT | mean_reversion | 6 | 1.281 | 43% | rsi_oversold=20.0, atr_mult_stop=1.8, rsi_overbought=75.0 |
| ARBUSDT | mean_reversion | 6 | 1.652 | 43% | rsi_oversold=30.0, atr_mult_stop=1.8, rsi_overbought=75.0 |
| ETCUSDT | mean_reversion | 6 | 1.845 | 42% | rsi_oversold=30.0, atr_mult_stop=1.8, rsi_overbought=80.0 |
| PYTHUSDT | mean_reversion | 6 | 1.505 | 41% | rsi_oversold=25.0, atr_mult_stop=1.8, rsi_overbought=70.0 |
| AVAXUSDT | breakout | 6 | 1.323 | 37% | rr=2.5, compression=0.05, volume_spike=1.8 |
| IMXUSDT | mean_reversion | 6 | 1.469 | 36% | rsi_oversold=30.0, atr_mult_stop=1.2, rsi_overbought=80.0 |
| OPUSDT | breakout | 6 | 1.31 | 33% | rr=3.0, compression=0.05, volume_spike=1.8 |
| ADAUSDT | mean_reversion | 6 | 1.683 | 30% | rsi_oversold=30.0, atr_mult_stop=1.0, rsi_overbought=70.0 |
| ATOMUSDT | mean_reversion | 6 | 1.697 | 30% | rsi_oversold=25.0, atr_mult_stop=1.8, rsi_overbought=70.0 |
...
| AVAXUSDT | mean_reversion | 6 | 1.503 | 23% | rsi_oversold=25.0, atr_mult_stop=1.8, rsi_overbought=75.0 |
...
| JUPUSDT | mean_reversion | 6 | 1.175 | 14% | rsi_oversold=30.0, atr_mult_stop=1.8, rsi_overbought=75.0 |
| UNIUSDT | mean_reversion | 6 | 1.241 | 14% | rsi_oversold=30.0, atr_mult_stop=1.0, rsi_overbought=70.0 |
...
| APTUSDT | mean_reversion | 6 | 1.126 | 11% | rsi_oversold=30.0, atr_mult_stop=1.2, rsi_overbought=75.0 |
| LTCUSDT | mean_reversion | 6 | 1.202 | 11% | rsi_oversold=25.0, atr_mult_stop=1.2, rsi_overbought=70.0 |
| AAVEUSDT | mean_reversion | 6 | 1.199 | 11% | rsi_oversold=30.0, atr_mult_stop=1.0, rsi_overbought=70.0 |
| LINKUSDT | liquidity_grab | 6 | 1.261 | 9% | volume_spike=2.0, atr_mult_stop=1.5 |
| ICPUSDT | mean_reversion | 6 | 1.129 | 9% | rsi_oversold=20.0, atr_mult_stop=1.8, rsi_overbought=75.0 |
| PYTHUSDT | liquidity_grab | 6 | 1.121 | 6% | volume_spike=2.5, atr_mult_stop=1.0 |
| TONUSDT | mean_reversion | 5 | 1.117 | 5% | rsi_oversold=25.0, atr_mult_stop=1.8, rsi_overbought=75.0 |
