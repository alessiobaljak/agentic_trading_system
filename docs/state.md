...
_Generato: 2026-09-24 04:51 UTC_
...
- DRY_RUN: True
- equity: **$952.35**
- ultimo heartbeat: 2026-09-24 04:51 UTC
- stream prezzi: 🟢 attivo

## Ultima decisione
- esito: **⚪ FLAT** (2026-09-24 04:46 UTC)
- motivo: nessun segnale valido sopra soglia
- asset valutati: 27 · segnali: 0

## Posizioni aperte
- DEXEUSDT: short qty=50.464597296481216 @ 1.885 uPnL=-0.3554260435902496 · rischio 0.15% · leva 1.0x
- DOTUSDT: long qty=86.53586057611031 @ 1.1007 uPnL=1.9996593170843642 · rischio 0.24% · leva 1.0x
- **rischio aperto totale: 0.38%** dell'equity su 2 posizioni

## GATE 1 — Validazione strategie
- stato: **✅ SUPERATO — pronti per il paper trading**
- copertura universo: **27/200 crypto (14%)** · obiettivo ≥ 35%
- coppie validate (>= 3 pass OOS): **59**
- universo scansionato: 0GUSDT, 1000BONKUSDT, 1000FLOKIUSDT, 1000LUNCUSDT, 1000PEPEUSDT, 1000SHIBUSDT, 4USDT, AAVEUSDT, ACEUSDT, ADAUSDT, AEROUSDT, AINUSDT, AKEUSDT, AKTUSDT, ALGOUSDT, ALLOUSDT, APEUSDT, APTUSDT, ARBUSDT, ARUSDT, ASTERUSDT, ATHUSDT, ATOMUSDT, AVAUSDT, AVAXUSDT, AXSUSDT, B2USDT, BANKUSDT, BBUSDT, BCHUSDT, BEATUSDT, BERAUSDT, BIOUSDT, BNBUSDT, BOMEUSDT, BROCCOLI714USDT, BRUSDT, BSVUSDT, BTCUSDT, BTRUSDT, BTWUSDT, CAKEUSDT, CAPUSDT, CCUSDT, CELRUSDT, CHIPUSDT, CHRUSDT, CHZUSDT, COMPUSDT, COTIUSDT, CRVUSDT, DASHUSDT, DATAIPUSDT, DEXEUSDT, DOGEUSDT, DOTUSDT, DRIFTUSDT, EDENUSDT, EDGEUSDT, EGLDUSDT, EIGENUSDT, ENAUSDT, ENSUSDT, EPICUSDT, ETCUSDT, ETHFIUSDT, ETHUSDT, EULUSDT, EVAAUSDT, FARTCOINUSDT, FETUSDT, FFUSDT, FIGHTUSDT, FILUSDT, FLOCKUSDT, FLOWUSDT, FOLKSUSDT, FORMUSDT, GALAUSDT, GENIUSUSDT, GIGGLEUSDT, GPSUSDT, GRAMUSDT, GRASSUSDT, GRTUSDT, GUSDT, HBARUSDT, HEMIUSDT, HUSDT, HYPEUSDT, ICPUSDT, INJUSDT, IOSTUSDT, JTOUSDT, JUPUSDT, KAITOUSDT, KERNELUSDT, KITEUSDT, KMNOUSDT, LABUSDT, LAUSDT, LDOUSDT, LINKUSDT, LITUSDT, LPTUSDT, LSKUSDT, LTCUSDT, LUNA2USDT, MAGMAUSDT, MARSCOINUSDT, METUSDT, MINAUSDT, MONUSDT, MOODENGUSDT, MORPHOUSDT, MOVEUSDT, MUBARAKUSDT, MYXUSDT, NEARUSDT, NEIROUSDT, NILUSDT, NOMUSDT, ONDOUSDT, ONEUSDT, ONGUSDT, OPUSDT, ORCAUSDT, ORDIUSDT, PAXGUSDT, PENDLEUSDT, PENGUUSDT, PEOPLEUSDT, PHAUSDT, PIEVERSEUSDT, PLUMEUSDT, PNUTUSDT, POLUSDT, PONSUSDT, POWERUSDT, POWRUSDT, PROMUSDT, PTBUSDT, PUMPUSDT, PYTHUSDT, RAYSOLUSDT, RENDERUSDT, REUSDT, RIVERUSDT, SAGAUSDT, SANDUSDT, SEIUSDT, SENTUSDT, SKYUSDT, SLXUSDT, SNXUSDT, SOLUSDT, SPXUSDT, STEEMUSDT, STRKUSDT, STXUSDT, SUIUSDT, SUPERUSDT, SUSDT, SUSHIUSDT, SYNUSDT, TAKEUSDT, TAOUSDT, TIAUSDT, TRBUSDT, TRIAUSDT, TRUMPUSDT, TRXUSDT, TUSDT, TUTUSDT, UAIUSDT, UBUSDT, UNIUSDT, USELESSUSDT, VETUSDT, VIRTUALUSDT, VTHOUSDT, VVVUSDT, WIFUSDT, WLDUSDT, WLFIUSDT, XAUTUSDT, XLMUSDT, XMRUSDT, XNYUSDT, XPLUSDT, XRPUSDT, ZAMAUSDT, ZECUSDT, ZENUSDT, ZESTUSDT, ZETAUSDT, ZKUSDT, ZROUSDT, 牛来USDT, 龙虾USDT
- aggiornato: 2026-09-24 03:11 UTC

### Salute del registro

- composizione: **1768 base** · **1184 generate** (di cui 1184 con almeno una conferma)
- occupazione: 2952/3000 — ok
...
**strategie generate** — 445 valutazioni, 1 passate (0.22%) · 2026-09-24 03:11 UTC
...
- ultimo giro: 2026-09-24 04:03 UTC · coppie validate: **59** · GATE 1 pronto: True
...
- totale: **43** · vinti: 16 (37%) · PnL realizzato: **-47.65**

- costi: **11.18 USDT** su 43 trade (0.26/trade) _(stimati dal modello del gate, non misurati dai fill)_
  - commissioni 6.26 · spread 4.97 · funding -0.06
  - lordo -36.47 → netto -47.65 · **break-even 1.17%** dell'equity
  - piu' costose: DEXEUSDT 1.91 · SPXUSDT 1.24 · USELESSUSDT 0.94 · SYRUPUSDT 0.93 · VETUSDT 0.78

| Uscita | Trade | % | PnL |
|---|---|---|---|
| Stop loss (prima di qualsiasi TP) | 27 | 63% | -121.79 |
| Trailing stop | 8 | 19% | +23.26 |
...
- gradini raggiunti (su 43 trade): 0 TP: 35 (81%) · 1 TP: 5 (12%) · 2 TP: 1 (2%) · 3 TP: 2 (5%)

- **drawdown di portafoglio: 61.78 USDT** (ritorno -47.65 · recovery -0.77) · max 7 posizioni aperte insieme
  _uscite in ordine di TEMPO: e' la buca vera, quella che il gate non vede perche' valida una coppia alla volta._

- escursione favorevole (mfe_r, 43 trade): mediana **0.84R** · ≥1R: 42% · ≥1.5R: 26% · ≥3R: 7% · ≥5R: 2%
...
- **globale**: drift · 43 trade · PF vissuto 0.609 vs 1.885 atteso · mfe mediana 0.84R
...
- verdetto: **ok** · 43 trade · correlazione 0.0 · influenza applicata **x1.0**
- la confidenza ordina correttamente gli esiti

| Fascia di confidenza | Trade | Win rate | Esito medio |
|---|---|---|---|
| 60.0–60.0 | 14 | 57% | -1.45% |
| 60.0–60.0 | 14 | 29% | -1.84% |
