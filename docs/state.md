...
| DEXEUSDT | gen_b31d8b93 | 3 | 1.872 | 94% | scale_r_mults=[1.5, 3.0, 5.0] |
...
- totale: **13** · vinti: 2 (15%) · PnL realizzato: **-20.05**

- costi: **4.00 USDT** su 13 trade (0.31/trade) _(stimati dal modello del gate, non misurati dai fill)_
  - commissioni 2.07 · spread 1.93 · funding +0.00
  - lordo -16.06 → netto -20.05 · **break-even 0.41%** dell'equity
  - piu' costose: DEXEUSDT 0.96 · SYRUPUSDT 0.63 · VETUSDT 0.54 · GPSUSDT 0.34 · NEIROUSDT 0.32

| Uscita | Trade | % | PnL |
|---|---|---|---|
| Stop loss (prima di qualsiasi TP) | 11 | 85% | -34.23 |
| Take profit (fino all'ultimo gradino) | 1 | 8% | +10.30 |
| Scale-out (>=1 TP incassato, residuo a BE) | 1 | 8% | +3.87 |

- gradini raggiunti (su 13 trade): 0 TP: 11 (85%) · 1 TP: 1 (8%) · 3 TP: 1 (8%)

- **drawdown di portafoglio: 20.05 USDT** (ritorno -20.05 · recovery -1.00) · max 4 posizioni aperte insieme
  _uscite in ordine di TEMPO: e' la buca vera, quella che il gate non vede perche' valida una coppia alla volta._

- escursione favorevole (mfe_r, 13 trade): mediana **0.74R** · ≥1R: 31% · ≥1.5R: 23% · ≥3R: 8% · ≥5R: 0%
...
- **globale**: watch · 13 trade · PF vissuto 0.414 vs 1.853 atteso · mfe mediana 0.74R
...
- verdetto: **insufficient** · 13 trade · correlazione None · influenza applicata **x1.0**
- servono 30 trade, ce ne sono 13
